...
igraph::write_graph(Trial.path, "Enriched_Clustered_NoEstimator.graphml", format = "graphml")
...
igraph::write_graph(JS.Trial.path, "Enriched_Clustered_JS_Estimator.graphml", format = "graphml")
