...
#Reduce Network to Significantly enriched Clusters
Keep = as.vector(unlist( JS_Clust_bt[ which( JS_Vect_cor < 0.05 ) ] ))
...
# Store SVA results
ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='~/igraph_Network_Expansion/Enriched_Clustered_JS_Estimator.graphml', name = 'Clustered_JS_Estimator-Kinase List', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, executed = thisFile, activityDescription = activityDescription)
  syn_temp$setAnnotations(ENRICH_OBJ, annotations = all.annotations)
 
ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='~/igraph_Network_Expansion/Enriched_Clustered_NoEstimator.graphml', name = 'Clustered_No_Estimator-Kinase List', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, executed = thisFile, activityDescription = activityDescription)
  syn_temp$setAnnotations(ENRICH_OBJ, annotations = all.annotations)
